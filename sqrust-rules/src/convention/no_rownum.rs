...
const MESSAGE: &str =
    "ROWNUM is Oracle-specific; use ROW_NUMBER() OVER() or FETCH FIRST N ROWS ONLY for portable pagination";

impl Rule for NoRownum {
...
fn find_violations(source: &str, rule_name: &'static str) -> Vec<Diagnostic> {
    ...
    // "ROWNUM" is 6 characters
    let keyword = b"ROWNUM";
    ...
    while i + kw_len <= len {
        ...
        // Case-insensitive match of "ROWNUM"
        ...
        // Check word boundary after — must not be followed by a word character
        // This prevents matching "rownum_value" etc.
